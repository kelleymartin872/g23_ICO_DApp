...
describe("ICO and ICOToken", function () {
  ...
  beforeEach(async () => {
    ...
    ico = await ICO.deploy(
      token.address,
      ethers.utils.parseEther("0.1"), // Soft cap
      ethers.utils.parseEther("1"), // Hard cap
      ethers.utils.parseEther("0.01"), // Min purchase amount
      ethers.utils.parseEther("0.05"), // Max purchase amount
      startTime,
      endTime
    );
    await ico.deployed();
